...
no_button.addEventListener("click", function(){
    ...
    const maxX = window.innerWidth - no_button.offsetWidth;
    const maxY = window.innerHeight - no_button.offsetHeight;
    
    no_button.style.left = Math.round(Math.random() * maxX) + "px";
    no_button.style.top = Math.round(Math.random() * maxY) + "px";
});
